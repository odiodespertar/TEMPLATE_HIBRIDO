...
# 🟢 CADENA NORMAL SIN LA 'f' INICIAL PARA EVITAR ERRORES DE SINTAXIS EN PYTHON CON LLAVES CSS
app_html = """
<!DOCTYPE html>
<html>
<head>
    ...
    <div id="fleet-sticky" class="fleet-normal">
        ...
        <div id="tab-2" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-2">__ROWS_2__</tbody>
            </table>
        </div>
        ...
        <div id="tab-6" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-6">__ROWS_6__</tbody>
            </table>
        </div>
        ...
        <div id="tab-7" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-7">__ROWS_7__</tbody>
            </table>
        </div>
        ...
        <div id="tab-8" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-8">__ROWS_8__</tbody>
            </table>
        </div>
        ...
        <div id="tab-1" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-1">__ROWS_1__</tbody>
            </table>
        </div>
        ...
        <div id="tab-5" class="t-content" style="display:none;">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-5">__ROWS_5__</tbody>
            </table>
        </div>
        ...
        <div id="tab-4" class="t-content">
            <table class="meli-table" style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                ...
                <tbody id="body-4">__ROWS_4__</tbody>
            </table>
        </div>
        ...
        <div id="tab-9" class="t-content" style="display:none;">
            <table class="meli-table">
                ...
                <tbody id="body-9">__ROWS_9__</tbody>
            </table>
        </div>
    </div>
</div>
...
<div style="width:100%; overflow-y:auto;">
    ...
    <div id="polys-2" class="p-content" style="display:none;">__POLYS_C1__</div>
    <div id="polys-6" class="p-content" style="display:none;">__POLYS_SJA1__</div>
    <div id="polys-7" class="p-content" style="display:none;">__POLYS_SCH1__</div>
    <div id="polys-8" class="p-content" style="display:none;">__POLYS_SMD1__</div>
    <div id="polys-1" class="p-content" style="display:none;">__POLYS_PREC__</div>
    <div id="polys-5" class="p-content" style="display:none;">__POLYS_SMX2__</div>
    <div id="polys-4" class="p-content">__POLYS_SDE__</div>
    <div id="polys-9" class="p-content" style="display:none;">__POLYS_VACIA__</div>
</div>
...
<script>
    const perfiles = __PERFILES_JSON__;
    const perfilActual = "__PERFIL_ACTUAL__";
...
# ==========================================
# INYECCIÓN LIMPIA DE FILAS Y POLÍGONOS DENTRO DEL HTML BASE
# ==========================================
app_html = app_html.replace("__ROWS_2__", gen_master_rows(u_C1, 2))
app_html = app_html.replace("__ROWS_6__", gen_master_rows(u_C1_SJA1, 6))
app_html = app_html.replace("__ROWS_7__", gen_master_rows(u_C1_SCH1, 7))
app_html = app_html.replace("__ROWS_8__", gen_master_rows(u_C1_SMD1, 8))
app_html = app_html.replace("__ROWS_1__", gen_master_rows(u_PREC, 1))
app_html = app_html.replace("__ROWS_5__", gen_master_rows(u_PREC_SMX2, 5))
app_html = app_html.replace("__ROWS_4__", gen_master_rows(u_SDE, 4))
app_html = app_html.replace("__ROWS_9__", gen_master_rows(u_C1_VACIA, 9))

app_html = app_html.replace("__POLYS_C1__", gen_poligonos(u_C1))
app_html = app_html.replace("__POLYS_SJA1__", gen_poligonos(u_C1_SJA1))
app_html = app_html.replace("__POLYS_SCH1__", gen_poligonos(u_C1_SCH1))
app_html = app_html.replace("__POLYS_SMD1__", gen_poligonos(u_C1_SMD1))
app_html = app_html.replace("__POLYS_PREC__", gen_poligonos(u_PREC))
app_html = app_html.replace("__POLYS_SMX2__", gen_poligonos(u_PREC_SMX2))
app_html = app_html.replace("__POLYS_SDE__", gen_poligonos(u_SDE))
app_html = app_html.replace("__POLYS_VACIA__", gen_poligonos(u_C1_VACIA))

app_html = app_html.replace("__PERFILES_JSON__", json.dumps(PERFILES))
app_html = app_html.replace("__PERFIL_ACTUAL__", perfil_actual)
app_html = app_html.replace("__SUPABASE_URL__", st.secrets.get('SUPABASE_URL', ''))
app_html = app_html.replace("__SUPABASE_KEY__", st.secrets.get('SUPABASE_KEY', ''))
