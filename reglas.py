...
reglas_ruteo = {
    ...
    "smx5_precarga": (
        ...
        "* 📌 Origen: MXCD09 + onway\n"
        "* 👉 Small Van MLP - Chalco, Tlalpan sur y Xochimilco\n"
        "* 👉 Car 5h Extendida - Xochimilco\n"
        "* 👉 Motos - Coyoacán (todas las motos van aquí)\n"
        "* 👉 Resto de planes - Car - 8h y Small van 9h\n"
    ...
    "smd1": (
        ...
        "* 🔴 **Centro:** ➤ Extra large van H&B (son 3 de 50 ids c/u = ciudad Mérida) / MLP Bulk (pueden ir 2 en un centro y 1 en otro /depende en cuál haya + voluminosos) / Delivery Cell LV\n"
        "* 🟠 **Norte:** ➤ Prioridad = Crowd zon ext 10hrs / MLP\n"
        "* 🟡 **Kanasin:** ➤ Si sobran crowd colocarlas aquí\n"
        "* 🟣 **Resto de planes:** ➤ Large Van MLP\n"
        "* 🔵 **Plan ND:** ➤ Tekax = Large Van MLP\n"
